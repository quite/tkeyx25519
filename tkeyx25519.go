...
// app, see https://dev.tillitis.se/intro/. "domain = domainString" if
// the latter is at most 32 bytes, otherwise "domain =
// blake2s(domainString)". userSecret for personalization/identity is
// expected to be randomly generated. requireTouch indicates whether
// the key should require physical touch when the DoECDH function
